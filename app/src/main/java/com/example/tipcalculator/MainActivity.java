/*
Assignment: Homework Assignment Number 1
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customTip = findViewById(R.id.textViewProgress);
        radioGroup = findViewById(R.id.radioGroup);
        totalBill = findViewById(R.id.editText_BillValue);
        billValue = totalBill.getText();
        tipValueTextView = findViewById(R.id.textView_finalTip);
        totalBillValue = findViewById(R.id.textView_finalAmount);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                customSeekBarChanges(billValue, progress);
            }
    ...
    private  void customSeekBarChanges(CharSequence billValue, int progess){
        String billValueInString = billValue.toString();
